...
```
https://github.com/YOUR_USERNAME/Prelnterview-Corporate-Analysis
```
...
git clone https://github.com/YOUR_USERNAME/Prelnterview-Corporate-Analysis.git \
  ~/.claude/skills/Prelnterview-Corporate-Analysis

# 创建你的个人信息文件
cp ~/.claude/skills/Prelnterview-Corporate-Analysis/profile.template.md \
   ~/.claude/skills/Prelnterview-Corporate-Analysis/profile.md
